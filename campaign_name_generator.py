...
targeting = coltargeting.selectbox(
    ...
    'InMarketAudience', 'AffinityAudience', 'SimilarToLeads', 'BusinessPlacement', 'Multiple', 'RLSA', 'SimilarAudiences')
)
...
product = colproduct.selectbox(
    'Product Name:',
    ('NA', 'Dueler', 'Potenza', 'Alenza', 'Ecopia', 'ContentHub', 'UGC', 'SME', 'Polyethylene', 'Polypropylene', 'FoodPackaging')
)
